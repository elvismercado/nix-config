...
#   custom.amdRyzen93900x.enable = true;
...

{
  ...
  options = {
    custom.amdRyzen93900x.enable = lib.mkEnableOption "enables AMD Ryzen 9 3900X CPU profile";
  };

  config = lib.mkIf config.custom.amdRyzen93900x.enable {
